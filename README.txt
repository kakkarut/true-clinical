...
This script will:
	...
	-Add a CRO/pharma to this contract - in this case bsc
	-Upload the trial protocol (data/TrialProtocol.pdf) to IPFS, running locally
	-Deploy a Clinical Trial smart contract - in this case for some random product, including the IPFS hash linking to the protocol
